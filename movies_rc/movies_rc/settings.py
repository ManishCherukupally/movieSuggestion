"""
Django settings for movies_rc project.
...
SECRET_KEY = 'django-insecure-tcwd*t&r*i4ri-4mu_!h&6dmt60sa%$y&dp!ua=!5uw+jc#-ut'
...
WSGI_APPLICATION = 'movies_rc.wsgi.application'
